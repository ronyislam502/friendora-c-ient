  ...
  return (
    <div className="form-control w-full">
      <label className="label mb-1">
        <span className="text-[12px] font-black text-success uppercase tracking-widest italic">
          {label}
        </span>
      </label>
      <select
        {...register(name)}
        className={`w-full bg-primary/5 border border-primary/30 rounded-2xl px-6 py-4
          ...
          ${errors[name] ? "border-red-500/40" : "border-primary/60"}
        `}
      >
